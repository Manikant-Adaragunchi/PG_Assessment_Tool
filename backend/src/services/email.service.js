...
exports.sendOnboardingEmail = async (email, password, role, fullName = 'User') => {
    try {
        ...
        const info = await transporter.sendMail({
            from: '"MeridianMD Admin" <admin@hospital.com>',
            to: email,
            subject: 'Welcome to MeridianMD - Your Login Credentials',
            html: `
<!DOCTYPE html>
<html>
<body style="font-family: Arial, sans-serif; color: #333; padding: 20px;">
  <div style="max-width: 600px; margin: auto; border: 1px solid #e5e5e5; border-radius: 8px; padding: 20px;">
    ...
    <h2 style="color: #0066cc; text-align: center;">Welcome to MeridianMD</h2>
    <p>Dear <b>${fullName}</b>,</p>

    <p>Your account has been successfully created in the <b>MeridianMD – PG Assessment Tool</b>.</p>
    ...
    <br/>
    <p>Regards,<br/>
    <b>MeridianMD Administration Team</b></p>
